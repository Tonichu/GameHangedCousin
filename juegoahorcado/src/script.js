...
function checkUserLetter() { // Sustitucion por letra acertada o resta el numero de intentos
  ...
  nodeLetter.focus();
  // Recorremos las letras, para ver si alguna coincide. devuelve una matriz de pares [key, value].
  ...
  if (!wordToGuess.includes(letterUser)) {
    ...
    switch (numIntentos) {
      case 1:
        primos = document.querySelector(`#manOne`);
        break;
      case 2:
        let manTwo = document.querySelector(`#manTwo`);
        manTwo.classList.remove(`hiddenMen`);
        manTwo.classList.add(`showMen`);
        break;
      case 3:
        let manThree = document.querySelector(`#manThree`);
        manThree.classList.remove(`hiddenMen`);
        manThree.classList.add(`showMen`);
        break;
      case 4:
        let manFour = document.querySelector(`#manFour`);
        manFour.classList.remove(`hiddenMen`);
        manFour.classList.add(`showMen`);
        break;
      case 5:
        let manFive = document.querySelector(`#manFive`);
        manFive.classList.remove(`hiddenMen`);
        manFive.classList.add(`showMen`);
        break;
      case 6:
        let manSix = document.querySelector(`#manSix`);
        manSix.classList.remove(`hiddenMen`);
        manSix.classList.add(`showMen`);
        break;
      case 7:
        let manSeven = document.querySelector(`#manSeven`);
        manSeven.classList.remove(`hiddenMen`);
        manSeven.classList.add(`showMen`);
        break;
      case 8:
        let manEight = document.querySelector(`#manEight`);
        manEight.classList.remove(`hiddenMen`);
        manEight.classList.add(`showMen`);
        break;
      case 9:
        let manNine = document.querySelector(`#manNine`);
        manNine.classList.remove(`hiddenMen`);
        manNine.classList.add(`showMen`);
        break;
    }
...
function endGame() {
  ...
  if (numIntentos == 0) {
    ...
    alert(`Te has quedado sin primos, la palabra era ` + wordToGuess.join(''));
    location.reload(true);
  }
}